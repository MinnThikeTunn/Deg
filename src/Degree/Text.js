...
function Text() {
  ...
  return (
    <div className="text-section w-100 h-fit py-8 ">
      <AnimatePresence>
      <motion.p ref={TextRef} initial={{ opacity: 0, rotate: 2, y: 30 }} animate={{ rotate: isInView? 0: 2, opacity:isInView? 1: 0,y: isInView? 0: 30 }} transition={{ type: "spring", stiffness: 130 }} className="m-auto ps-4 md:w-4/6 md:ps-0 leading-8 font-normal text-[18px] sm:text-[24px] md:text-[28px] text-left"
